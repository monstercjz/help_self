...
from PySide6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QPushButton,
                                ...
                                QMessageBox, QLabel)
from PySide6.QtCore import Qt, Signal, QPoint # 导入 QPoint
from PySide6.QtGui import QIcon
from PySide6.QtWidgets import QMenu # 导入 QMenu
...
class SshClientView(QWidget):
    ...
    def _on_connection_list_context_menu(self, pos: QPoint): # 将 Qt.QPoint 改为 QPoint
        """
        连接列表的右键菜单。
        """
